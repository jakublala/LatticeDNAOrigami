...
"""A script to create input json files from sequences for single-removal (SR) simulations"""
...
def generate_JSONfile(removedStaple):
    STAPLE_SEQFILE = 'seqs/snodin_staples_{}.seq'.format(removedStaple)
    ...
    OUTPUT_FILENAME = 'jsons/snodin_unbound_{}.json'.format(removedStaple)
...
for stapleIndex in range(numberOfStaples + 1):
    generate_JSONfile(stapleIndex)
